...
async function recursiveExploration(page, link, depth, parentState) {
  ...
  if(link=='http://localhost:2370/tag/getting-started/' || link=='http://localhost:2370/author/ghost/' || link=='https://github.com/TryGhost' || link=='http://localhost:2370/the-editor/'){
    return
  }
  ...
  if (link != 'http://localhost:2370/,http://localhost:2370/tag/getting-started/,http://localhost:2370/author/ghost/,https://ghost.org/docs/,https://www.facebook.com/ghost,https://twitter.com/ghost,https://feedly.com/i/subscription/feed/http://localhost:2370/rss/,http://localhost:2370/welcome/,http://localhost:2370/the-editor/,http://localhost:2370/publishing-options/,http://localhost:2370/admin-settings/,http://localhost:2370/organising-content/,http://localhost:2370/apps-integrations/,http://localhost:2370/themes/,https://ghost.org/') {
