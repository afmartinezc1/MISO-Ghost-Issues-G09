Feature: change password Staff
  ...
  Scenario: Como usuario inicio sesion en ghost, entro a staff, y modifico la contraseña de un usuario, me deslogueo e ingreso con la nueva
    ...
    And I wait for 1 seconds
    And I fill user new password in staff with text a-priori
    And I wait for 1 seconds
    And I fill user new password verification in staff with text a-priori
    And I wait for 1 seconds
    ...
    And I wait for 2 seconds
    And I enter email a-priori
    And I wait for 2 seconds
    And I enter password a-priori
    And I wait for 2 seconds
    And I click SignIn    
    And I wait for 5 seconds
