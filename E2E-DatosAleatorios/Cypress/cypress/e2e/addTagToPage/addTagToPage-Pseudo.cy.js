...
describe("Add Tag To Page", () => {
  ...
  it("Como usuario inicio sesion en ghost, creo un tag y un page, selecciono el page, le agregó el tag y verificó que el tag se agregó correctamente", async () => {
    cy.pseudoData().then((response) => {
        ...
        cy.get(pageElements.tag.inputDescription).type(data0.text.substring(0,499));
        ...
        .and('contain', data0.text.substring(0,499));
        ...
        // And I wait for 2 seconds
        cy.wait(2000);
        // Then I should see the first draft page with title pseudo
