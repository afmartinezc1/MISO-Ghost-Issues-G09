...
describe("Delete page draft", () => {
  it("Como usuario inicio sesion en ghost, creo una page, reviso que esté en la lista de draft pages, creo otra page, reviso que esté en la lista de draft pages, borro esta page, y valido que la primera page de la lista de draft pages sea la primera que cree, con lo cual me cercioro que la segunda page efectivamente fue borrada", async () => {
    cy.aprioriData().then((aprioriData) => {
      ...
      // And I wait for 2 seconds
      cy.wait(2000);
      // And I enter page title apriori1
      cy.get(pageElements.page.pageTitle).type(aprioriData[0].title);
      // And I wait for 2 seconds
      cy.wait(2000);
      // And I enter page content apriori1
      ...
      // And I wait for 2 seconds
      cy.wait(2000);
      // Then I should see the first draft page with title apriori1
      ...
      // And I wait for 2 seconds
      cy.wait(2000);
      // And I enter page title apriori2
      cy.get(pageElements.page.pageTitle).type(aprioriData[1].title);
      // And I wait for 2 seconds
      cy.wait(2000);
      // And I enter page content apriori2
      cy.get(pageElements.page.pageContent).type(aprioriData[1].text);
      // And I click pages to go to previous page
      cy.get(pageElements.page.newPagePreviousPage).click();
      // And I wait for 2 seconds
      cy.wait(2000);
      // Then I should see the first draft page with title apriori2
      cy.get(pageElements.page.firstPageInList)
        .invoke("text")
        .then((text) => {
      ...
      // And I wait for 2 seconds
      cy.wait(2000);
      // Then I should see that the page title is apriori2
      ...
      // And I wait for 2 seconds
      cy.wait(2000);
      // Then I should see that the page content is apriori2
      ...
      // And I wait for 2 seconds
      cy.wait(2000);
      // Then I should see that the page title is apriori1
      cy.get(pageElements.page.pageTitle).should(
        "have.value",
        aprioriData[0].title
      );
      // And I wait for 2 seconds
      cy.wait(2000);
      // Then I should see that the page content is apriori1
      cy.get(pageElements.page.pageContent).should(
        "have.text",
        aprioriData[0].text
      );
